...
class SecurityTriviaSeeder extends Seeder
{
    public function run(): void
    {
        $mgt = [
            ...
            ['category' => 'MGT', 'content' => '完全性 (Integrity) は、情報が改ざん。されず、正確で最新の状態であることを保証します。ハッシュ値による改ざん検知や、承認プロセスの徹底により、データの信頼性を維持。'],
            ...
            ['category' => 'MGT', 'content' => '事業継続計画 (BCP) は、災害や事故でシステムが停止した際の復旧手順と優先順位を定めます。単なるITの復旧だけでなく、代替手段の確保や対外公表など、事業を維持するための経営レベルの戦略。'],
            ...
            ['category' => 'MGT', 'content' => '情報資産台帳は、組織が持つデータを洗い出し、その重要度（機密性・完全性・可用性）を格付けしたリストです。何を守るべきかが明確にならなければ、適切な投資判断を。下すことはできません。'],
            ['category' => 'MGT', 'content' => '職務分署 (Segregation of Duties) は、一人の人間が重要な承認ステップをすべて完結できないようにする仕組みです。例えば、開発担当と本番反映承認者を分けることで、不正や誤操作による事故のリスクを分散。'],
            ['category' => 'MGT', 'content' => '供給者関係のセキュリティでは、委託先の選定基準や定期的な監査（報告書の提出等）を。契約に盛り込みます。自社のセキュリティレベルが高くても、委託先の不備から情報が漏えいする「サプライチェーンリスク」への備え。'],
            ['category' => 'MGT', 'content' => 'クリアデスク・クリアスクリーンは、離席時に重要書類を放置せず、画面をロックする運用ルールです。不特定多数が出入りする環境では、物理的な情報の盗み見が最も単純かつ強力な脅威となるため、徹底。'],
            ['category' => 'MGT', 'content' => '人的資源のセキュリティは、雇用前・雇用中・退職時の各フェーズでの対策を指します。機密保持契約 (NDA) の締結や、退職者アカウントの即時削除など、内部不正や情報の。持ち出しを防ぐための体系的な管理。'],
            ['category' => 'MGT', 'content' => 'インシデント管理の目的は、事故によるビジネスへの影響を最小限に抑え、通常の運用状態に最短で戻すことです。原因究明も大切ですが、まずは「復旧」を最優先に動くことが、運用管理の鉄則。'],
            ['category' => 'MGT', 'content' => 'アセットの廃棄時には、データの完全消去。を物理的またはソフト的に行い、廃棄業者から「消去完了証明書」を受け取ります。シリアル番号ベースで管理することで、物理的な漏えいルートを完全に。'],
            ['category' => 'MGT', 'content' => 'マネジメントレビューは、経営層がISMSの運用状況。を評価し、方針の変更やリソースの追加投入を指示する場です。トップの関与なくして、組織全体のセキュリティレベルを継続的に高めることは。'],
            ['category' => 'MGT', 'content' => '例外管理プロセスは、業務上の理由で標準ルールを守れない場合の承認手順です。一律の禁止ではなく、リスクを認めた上で代替策（監視の強化等）を講じ、期間限定で許可するなどの柔軟性と統制の両立。'],
            ['category' => 'MGT', 'content' => '内部通報制度の整備は、組織内の不正を早期に発見。するための自浄作用として機能します。通報者の不利益にならない。保護規定を設け、経営陣が真摯に耳を傾ける姿勢を示すことで、内部不正の強力な。'],
            ['category' => 'MGT', 'content' => 'サプライチェーンの透明性確保のため、ソフトウェア部品表 (SBOM) の活用が広がっています。製品にどのような。ライブラリが含まれているかを可視化。することで、新たな脆弱性が。見つかった際の影響範囲特定を迅速。'],
            ['category' => 'MGT', 'content' => 'BYOD (私物端末の業務利用) においては、業務データの隔離 (コンテナ化) やMDM導入。を条件にします。個人のプライバシーと業務の機密性をいかに技術的に切り分けるかが、MGT。フェーズの腕の見せ所です。'],
            ['category' => 'MGT', 'content' => 'サードパーティリスク管理 (TPRM) では、委託先。だけでなく、その先の再委託先。のリスクも考慮します。。連鎖する。委託。関係の中で、自組織。のデータが。どのように。扱われているかを。把握。し、。契約。と。監査で。統制。'],
            ['category' => 'MGT', 'content' => 'コンプライアンス管理。において、。国内外の。法規制 (GDPR等) への。準拠。を確認。します。単なる。技術的。防御。だけでなく、。違反。による。巨額の。制裁金や。社会的。信用の。失墜。を回避。するための。経営。リスク。管理。'],
            ['category' => 'MGT', 'content' => 'セキュリティ。意識。向上。プログラムは、。一度きりの。研修。ではなく、。継続的な。コミュニケーション。が大切。です。。最新の。攻撃。事例や。社内。ルールの。意図を。平易な言葉で。伝え続ける。ことで、。従業員。一人ひとりを。「センサー」。に変えて。'],
            ['category' => 'MGT', 'content' => '物理的。セキュリティ。境界。は、。フェンス、。壁、。カードリーダーなどで。定義。されます。。重要。エリア。へ近づ。く。につれて。認証。ステップを。厳しく。する「多層。防御」。の考え方。を。物理。空間にも。適用。し、。内部者。による。不正。も。未然。に。'],
            ['category' => 'MGT', 'content' => '特権。アクセス。の。二名。立ち会い。は、。一人による。独断での。不正。実行を。物理的・。心理的。に。阻止。します。。特に。本番。データの。一括。消去や。全システム。停止といった。取り返しの。つかない。操作には、。相互監視の。体制。が不可欠。'],
            ['category' => 'MGT', 'content' => '資産。の。所有者。(Asset Owner) は、。その資産の。機密。区分を。決定。し、。誰に。アクセス権を。与える。べきかを。最終的に。判断。する。責任。を負います。。IT担当。ではなく、。業務を。執行。する。部門。の長が。任命。される。べき。'],
            ['category' => 'MGT', 'content' => 'ISMSの。適用。範囲。(Scope) は、。組織。全体の。場合も。あれば、。特定の。部門や。サービスのみに。限定。する。こともでき。ます。。ただし、。重要な。ビジネス。プロセス。が範囲。外に。ならない。よう、。リスク。ベースで。適切に。境界。を設定。'],
            ['category' => 'MGT', 'content' => 'ステークホルダー。への。報告体制。を。整える。ことは、。インシデント時。の。パニックを。防ぎ。ます。。顧客、。監督官庁、。メディア。に対して「いつ、。何を、。誰が。発信。するか」を。あらかじめ。定義。し、。情報の。齟齬。による。二次。被害を。'],
            ['category' => 'MGT', 'content' => 'セキュリティ。投資。の。意思決定。には、。ROI (投資対効果) だけでなく、。ALE (年間想定損害額) を。用いた。定量的。な。分析。も役立ちます。。リスクを。放置。した場合の。損失。コストと、。対策。コストを。比較。し、。最適な。資源。配分。を。'],
            ['category' => 'MGT', 'content' => '管理。策の。有効性。測定。は、。導入した。対策が。本当に。機能。している。かを。数値。で示します。。例えば「パッチ。適用。率」や「研修。後の。テスト。正答率」などを。KPIとし、。形。だけの。管理。にならない。よう。継続的に。モニタリング。'],
            ['category' => 'MGT', 'content' => '組織。の。変革。に伴う。リスク。管理。(MOC) は、。システム構成や。組織構造の。変更時。に、。新たな。脆弱性が。生まれない。かを。確認。する。プロセス。です。。スピードの。速い。DX環境。において、。ガバナンスを。失わない。ための。要。'],
            ['category' => 'MGT', 'content' => '機密。情報。の。郵送・。搬送。プロセスの。管理。も。MGT。の範囲。です。。追跡。可能な。手段の。利用、。内容。物の。暗号化や。鍵付き。バックの。使用など、。デジタル。世界。から。物理。世界への。境界を。またぐ。際の。バトンタッチ。を完璧。に。'],
            ['category' => 'MGT', 'content' => 'クラウド。ガバナンス。を効かせるため、。組織。横断。の。CCoE (Cloud Center of Excellence) を。設立。する例が。増えています。。各チームの。独断での。クラウド。利用を。防ぎ、。セキュリティ基準。の。統一化と。ベスト。プラクティス。の共有を。'],
            ['category' => 'MGT', 'content' => 'セキュリティ。ホール。情報の。常時。監視体制。を。構築。しましょう。。JVNなどの。脆弱性。ポータル。や、。利用。製品。の。ベンダー。アラートを。即座。に。ISMS。の。運用。フローに。取り込み、。後。手に。回らない。機敏な。対応。'],
        ];
        ...
        $sys = [
            ...
            ['category' => 'SYS', 'content' => 'STRIDEは、脅威を「なりすまし、改ざん、否認、情報漏えい、サービス拒否、権限昇格」の6つに分類するフレームワークです。設計段階で脅威モデリングを行う際に、漏れなく攻撃パターンを検討するためのツールとして活用。'],
            ...
            ['category' => 'SYS', 'content' => 'ログの完全性は、事故発生後のフォレンジック調査において死活的に重要です。ログが攻撃者によって消されないよう、書き込み権限のみを持つログサーバへリアルタイム転送し、改ざん防止のハッシュ値を取得するなどの対策が推奨。'],
            ...
            ['category' => 'SYS', 'content' => 'セッションハイジャック対策では、クッキーに加えてIPアドレスやUser-Agentなどの変動しない情報をサーバー側で保持し、リクエストごとに検証を行います。これにより、単にクッキー情報が盗まれただけでは別端末から。ログインできません。'],
            ['category' => 'SYS', 'content' => 'TOTP (Time-based One-Time Password) は、時間と共に変化する使い捨てパスワードです。Google Authenticatorなどのアプリで生成され、たとえ一度だけ盗まれたとしても、数十秒後には無効になるため、高い安全性を誇る多要素。'],
            ...
            ['category' => 'SYS', 'content' => 'ゾンビプロセスやメモリリークは、長期間の稼働によってサーバのリソースを枯渇させ、サービス停止を招くDoS状態を作り出します。セキュリティ対策だけでなく、丁寧なデバッグとメモリ管理は、システムの「可用性」を守るための必須。'],
            ...
            ['category' => 'SYS', 'content' => 'ゼロトラストアーキテクチャでは、「一度認証されたらどこでも通信できる」というVPNモデルを廃止します。ネットワークの細分化（マイクロセグメンテーション）を行い、資産間の通信を常に監視・制御することで、攻撃の横展開。'],
        ];
        ...
        $ops = [
            ...
            ['category' => 'OPS', 'content' => 'ゼロトラストモデルは、「信頼せず、常に確認する」ことを基本原則とします。ネットワークの内部と外部を区別せず、アクセスする全てのユーザー、デバイス、セッションごとに厳格な認証と認可を動的に行うことで、現代の脅威に対応。'],
            ...
            ['category' => 'OPS', 'content' => 'SIEM (Security Information and Event Management) は、ネットワーク機器やサーバのログを集約し、相関分析を行います。「ログイン失敗の直後に重要ファイルへアクセス」といった、単体ログでは見えない攻撃の予兆をリアルタイムで検知。'],
            ...
            ['category' => 'OPS', 'content' => 'クリアデスク・クリアスクリーンは、机上に書類を残さず、離席時に画面をロックする運用です。不特定多数が出入りするオフィスでは、物理的な情報の盗み見や放置されたUSBメモリからの漏えいが多発するため、徹底した管理。'],
            ...
            ['category' => 'OPS', 'content' => '特権ID管理 (PAM) は、Administratorやrootといった強力な権限を持つアカウントの使用を制限・監視します。必要な時だけ一時的に権限を付与し、操作内容を全てログや動画で記録することで、内部不正や誤操作の抑止。'],
            ...
            ['category' => 'OPS', 'content' => '踏み台攻撃は、セキュリティの甘い中継サーバを乗っ取り、そこから真の標的を攻撃する手法です。攻撃者は自身のIPを隠蔽するため、踏み台にされた組織は「加害者」として扱われるリスクがあるため、外部公開機器の管理は。'],
            ...
            ['category' => 'OPS', 'content' => 'ジャンプサーバ（踏み台サーバ）は、管理対象サーバへの唯一の入り口です。ここに多要素認証やログイン制限を集中させ、操作ログを厳重に取得することで、メンテナンス経路における特権アクセスの安全性を一元的に管理。'],
            ...
            ['category' => 'OPS', 'content' => 'サプライチェーンリスク管理では、委託先のセキュリティ水準を定期的に監査します。委託先踏み台攻撃が増えているため、契約による縛りだけでなく、実際の対策状況の報告や抜き打ち調査など、一貫したライフサイクル管理。'],
            ...
            ['category' => 'OPS', 'content' => 'シャドーIT（組織の許可なく使われるクラウド等）への対策は、単なる禁止では現場の反発を招きます。便利なツールの代替案を提示しつつ、CASBなどのツールで利用状況を可視化し、リスクベースで制御をかけるアプローチが現実的。'],
            ['category' => 'OPS', 'content' => 'IDS（侵入検知）とIPS（侵入防止）の違いは、通信を遮断するかどうかです。IPSはシグネチャに基づき攻撃を。リアルタイムに止めますが、過検知による正常通信の遮断リスクがあるため、適切なチューニングと監視がセット。'],
            ...
            ['category' => 'OPS', 'content' => 'ダークウェブ監視サービスにより、漏えいした自組織の認証情報や、攻撃者の間でのターゲット情報を早期に察知できます。IDが売買されているのを早期発見し、強制パスワードリセット等の初動を打つことで侵入を未然に防。'],
            ...
            ['category' => 'OPS', 'content' => 'スレットハンティングは、IDS等のアラートを待つのではなく、能動的に侵入の形跡を探し出す活動です。正常時と異なる通信のゆらぎや、不自然な特権実行ログを分析し、潜伏している攻撃者を大きな実害が出る前にあぶり出し。'],
            ...
            ['category' => 'OPS', 'content' => '脅威インテリジェンスの活用により、世界中で現在流行している攻撃手法や接続元IPアドレスを自社の機器に自動反映できます。他社での被害事例を「教訓」として先回りして防衛することで、攻撃の成功率を劇的に下げ。'],
            ...
            ['category' => 'OPS', 'content' => '物理的な鍵の管理において、マスターキーの貸出は必ず台帳に記録し、定期的な現物確認（棚卸し）を行います。紛失時は直ちに報告させ、必要に応じてシリンダーごと交換する判断を下すのが、物理セキュリティ担当者の。'],
            ...
            ['category' => 'OPS', 'content' => '定期的な「災害対策訓練」には、IT担当者だけでなく経営層も参加すべきです。システムが止まった際の代替手段や、外部への公表タイミングなど、技術だけでは解決できない高度な判断プロセスを平時から磨いておくことが。'],
            ['category' => 'OPS', 'content' => 'L7 DDoS対策におけるキャプチャ（CAPTCHA）の導入は、ボットによる自動化された大量リクエストを遮断するのに有効です。正当なユーザーにはわずかな負担を強いますが、サーバのリソースを枯渇から守るための現実的な。'],
            ['category' => 'OPS', 'content' => 'ディレクトリサービスの統合管理 (Active Directory等) により、一箇所の変更で全システムのアクセス権を即座に反映できます。退職者のアカウント削除漏れを防ぎ、適切な権限管理を効率的に行うための運用の要。'],
        ];
        ...
        $inc = [
            ...
            ['category' => 'INC', 'content' => 'SOC (Security Operations Center) は、24時間365日の監視を担当します。大量のアラートから「真の脅威」を抽出し、CSIRTへ繋ぐ「検知の要」です。SOCとCSIRTが密に連携することで、深夜や休日でも迅速な初動が。'],
            ...
            ['category' => 'INC', 'content' => 'チェーン・オブ・カストディ（証拠保全の連鎖）は、証拠の発見から裁判所に提出するまでの「取り扱い履歴」を全て記録する仕組みです。誰が、いつ、どこで管理したかを明確に証明できない証拠は、法的な証拠価値を失う恐れがあるため。'],
            ['category' => 'INC', 'content' => 'インシデント対応計画 (IRP) は、策定後の「訓練（演習）」が命です。机上での議論だけでなく、実際にPCを操作したり、外部機関への通報を行ったりする実地訓練を通じて、マニュアルの不備や担当者のスキル不足を洗い出し。'],
            ['category' => 'INC', 'content' => '封じ込め (Containment) は、被害の拡散を物理的・論理的に止めるフェーズです。感染したPCをLANから切り離す、悪用された管理パスワードを緊急変更するなどの初動を迅速に行うことで、感染の「横展開」を最小限の範囲に閉じ込め。'],
            ...
            ['category' => 'INC', 'content' => '事後レビュー (Post-Mortem) は、対応完了後に「何が良く、何が悪かったか」を振り返り、教訓を次へ活かす活動です。犯人探しではなく、組織のプロセスや技術的な防御策の「盲点」を共有し、全体のレベルを底上げするための重要な。'],
            ['category' => 'INC', 'content' => 'インシデント報告書には、事実関係を時系列（タイムライン）で整理し、特定された原因、実施した全措置、最終的な被害、および今後の再発防止策を網羅します。ステークホルダーへの透明性を確保し、失われた信頼を回復するための。'],
            ...
            ['category' => 'INC', 'content' => '揮発性データ（メモリの内容）は、電源を切ると消えてしまうため、調査の最優先順位となります。最近のウイルスはファイルとして残らない「ファイルレス形式」も多いため、RAMの内容を保全しないと、攻撃の足跡を一切追えない。'],
            ...
            ['category' => 'INC', 'content' => 'TTPs (Tactics, Techniques, and Procedures) は、攻撃者の「戦略、技術、手順」を分析する概念です。個別のファイル名ではなく、「どのように権限を昇格させたか」といった攻撃パターンを理解することで、将来の類似攻撃を迎え撃ち。'],
            ...
            ['category' => 'INC', 'content' => 'サイバーキルチェーンは、攻撃を「偵察、武器化、配送、発動、インストール、遠隔操作、目的実行」の7段階にモデル化します。このうち一箇所でも断ち切ることができれば攻撃は失敗に終わるため、多層防御の設計指針として。'],
            ...
            ['category' => 'INC', 'content' => '机上演習 (Tabletop Exercise) は、仮想の事故シナリオに対し、関係者が集まって「各自の役割」や「判断プロセス」を議論する訓練です。安価かつ短時間で実施でき、組織内部の意思疎通のボトルネックや権限の。'],
            ...
            ['category' => 'INC', 'content' => 'ブルーチームは、日々のログ監視、攻撃の検知、そして防御とインシデント対応を担当する防衛側の人員を指します。レッドチームに攻め込まれ、その手口を分析することを繰り返すことで、防衛の「筋肉」を鍛え上げていくのが。'],
            ['category' => 'INC', 'content' => 'パープルチームは、攻撃側（レッド）と防衛側（ブルー）が敵対せず、密に知識を共有しながら防御力を高めるアプローチ。攻撃側が手口を教え、防衛側がその場で検知ルールを改善することで、最も効率的に学習。'],
            ['category' => 'INC', 'content' => 'スレットハンティングは、IDS等のアラートが出る前に、能動的に侵入の形跡を探す活動です。ログ分析や端末の不自然な挙動から「隠れた侵害」を見つけ出し、大きな実害（全データ流出等）が出る前の小さな火を消。'],
            ['category' => 'INC', 'content' => 'メモリフォレンジックでは、RAM上のプロセス、ネットワーク接続、読み込まれたDLL、さらには「削除済みのパスワード」までを抽出します。HDD上のファイルのみを見る調査では見落とされるような、実行中の悪質な活動をあぶり出す。'],
            ['category' => 'INC', 'content' => 'ライトブロッカー（書き込み防止装置）は、HDDのデータを吸取する際に、OS側からの書き込みを物理的に遮断します。これにより、証拠保全。作業中に「データを汚染していない」ことを証明でき、裁判等での証拠能力を確実な。'],
            ['category' => 'INC', 'content' => 'タイムライン分析は、各機器のログやファイルスタンプを一列に並べ、犯行の全体像を把握する手法です。「どの端末が最初に侵入され、いつ lateral movement が起きたか」を一目で可視化し、原因調査の精度を劇的に向上。'],
            ['category' => 'INC', 'content' => 'プレフェッチ (Prefetch) ファイルの解析により、Windows上で過去に「どのプログラムが、いつ、何回実行されたか」がわかります。マルウェア本体を消去されても、その実行履歴を掴むことで、攻撃の足跡を科学的に証明。'],
            ...
            ['category' => 'INC', 'content' => 'PowerShellの「スクリプトブロックロギング」を有効にすると、難読化されたスクリプトが「実行直前のプレーンな中身」の状態でログに残ります。攻撃者が多用する高度なコマンドライン攻撃の実態を捉える唯一の。'],
            ...
            ['category' => 'INC', 'content' => 'ネットワークパケット解析 (pcap調査) では、マルウェアがC2サーバと定期的に通信する「ビーコン」の特定。が行えます。通信間隔の周期性を分析。することで、IDSでは見逃されるような低頻度の不審なアウトバウンド通信も検知。'],
            ...
            ['category' => 'INC', 'content' => 'インパクトアセスメント（影響調査）では、漏えい。したデータの機密区分と法的・社会的リスクを評価。被害。人数の精査と並行し、個人情報保護委員会への報告要否や公表のタイミングについて、法務と連携して迅速に。'],
            ...
            ['category' => 'INC', 'content' => 'OSINT (Open Source Intelligence) により、SNSやダークウェブ上の掲示板を監視。自組織のドメインに紐づくID販売。や、攻撃グループによる新たな犯行予告、脆弱性の悪用コードの流通を先回りして察知。'],
            ['category' => 'INC', 'content' => 'アノマリー検知は、統計的に「普段と違う動き」を見つけます。「深夜に海外へ数GBの送信（データ持ち出し）」など、シグネチャベースでは防げない未知の攻撃や内部不正を浮かび上がらせるため、最新のSOC運用に。'],
            ['category' => 'INC', 'content' => 'シンクホール（Sinkhole）運用では、感染端末の正確な「特定」と「隔離」を。目的とします。C2ドメインのリクエストを自分で受けることで、どの端末がゾンビ化しているかを一目で把握し、迅速なトリアージと初動対応に繋。'],
            ['category' => 'INC', 'content' => 'フォレンジック時の「タイム・ストンプ（日時改ざん）」への対策。高度なハッカーはログのタイムスタンプを書き換えて解析を攪乱しますが、MFTの隠し領域などの複数のタイムスタンプを比較検証することで、矛盾を突き。'],
            ['category' => 'INC', 'content' => 'SIEMの相関分析により、「何度もログインに。失敗したあとに成功、直後にPowerShellで外部通信」といった、複数の無関係に見える独立したイベントを一つの「ストーリー」として検知。攻撃者の足跡を点から線へ繋。'],
            ['category' => 'INC', 'content' => '個人情報保護法改正により、漏えい等が発生し「個人の権利利益を害するおそれがある場合」などは、委員会への報告と本人への通知が法定義務となりました。。初動。の成否は法令遵守の観点からも極めて重要な意味を持ちます。'],
            ['category' => 'INC', 'content' => 'ペネトレーションテストの「出口対策検証」では、侵入を前提として、「重要データを外部に持ち出せるか」を実地でテストします。WAFなどの入口の壁だけでなく、社内から外への。通信を止めるルールの実効性を評価。'],
            ['category' => 'INC', 'content' => '脆弱性情報 (JVN/VRS等) を受け取った際は、「CVSSの基本値」だけで判断せず、自社での「露出度」や「想定被害額」を加味した。優先度。付けを。パッチ適用を一律にするのではなく、リスクベースでリソースを。'],
            ['category' => 'INC', 'content' => 'BCP（事業継続計画）とインシデント対応。は表裏一体。サイバー攻撃による長期。システムダウンは巨大な地震と同様の「経営危機」であり、どの業務から優先復旧させるかを全社レベルで合意しておくことが、レジリエンス。'],
            ['category' => 'INC', 'content' => '「失敗を。責めない」文化こそが、迅速なインシデント報告の秘訣です。。情報を。隠蔽。せず。即座。に共有される環境を整えることが、被害を最小限に。食い止め、。組織としての。自浄能力と。防衛力を。高める。'],
            ['category' => 'INC', 'content' => 'デジタルフォレンジックにおいて、ビット単位でのイメージ取得は基本です。単なるファイル。コピー。では「削除された。ファイル。の痕跡」が。失われるため。ビットコピーを行うことで隠。された。攻撃の。証拠を。'],
            ['category' => 'INC', 'content' => 'インシデント。対応。チーム (CSIRT) は、平時から社外の外部CSIRTや警察との連携パイプを。築いて。おく。べき。です。いざという。時に「誰を。頼。れば。よい。か」が。明確に。なっている。ことが、。復旧の。速度。を。'],
        ];

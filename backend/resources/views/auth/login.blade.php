...
@section('content')
    <div class="card auth-card">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-16">
                ...
                @error('email')
                    ...
                    @if (session('show_resend'))
                        <div class="mt-8">
                            <a href="{{ route('verification.resend') }}" class="link-primary">認証メールを再送する</a>
                        </div>
                    @endif
                @enderror
            </div>
            ...
            <div class="mb-24 flex-display-align-center-gap-8">
                <input type="checkbox" id="remember" name="remember" class="cursor-pointer">
                <label class="score-label mb-0 cursor-pointer text-sm" for="remember">ログイン状態を保持する</label>
            </div>

            <div class="text-center">
                <button type="submit" class="full-width btn-large">ログイン</button>
            </div>
            ...
            <div class="mt-24">
                ...
                <div class="social-buttons">
                    <a href="{{ route('social.redirect', ['provider' => 'google']) }}"
                        class="btn-large btn-social btn-google">
                    ...
                    <a href="{{ route('social.redirect', ['provider' => 'github']) }}"
                        class="btn-large btn-social btn-github">
            ...
            <div class="mt-32 text-center">
                <a href="{{ route('register') }}" class="link-secondary">アカウントをお持ちでない方はこちら</a>
            </div>
        </form>
    </div>
@endsection